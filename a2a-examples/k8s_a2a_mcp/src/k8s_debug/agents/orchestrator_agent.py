...
from k8s_debug.common.workflow import Status, WorkflowGraph, WorkflowNode
from google import genai


logger = logging.getLogger(__name__)

# What is orchestrator agent doing ?
                ...
                if isinstance(chunk.root, SendStreamingMessageSuccessResponse):
                    ...
                    if isinstance(chunk.root.result, TaskArtifactUpdateEvent):
                        ...
                        if artifact.name == 'PlannerAgent-result':
                            ...
                            if 'pod_info' in artifact_data:
                                self.travel_context = artifact_data['pod_info']
                            logger.info(
